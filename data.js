...
const disciplinesData = {
    ...
    'espagnol': { 
        ...
        content: `
            ...
            <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-3"><h3 class="font-bold text-blue-800 mb-2 border-b pb-1">Classe de 5ème</h3><ul class="list-disc ml-4 text-sm"><li>1 cahier Seyès 24X32 96p jaune</li><li>Cahier d'activités Hispamundo 5e, Lelivrescolaire 2026 (ISBN : 9791040008682)</li><li>Manuel numérique Hispamundo 5e, Lelivrescolaire 2026 (ISBN : 9791040009016)<br><em class="text-blue-800 mt-1 block">Le manuel est acheté et mis à disposition par l'établissement et refacturé via EDUKA aux familles.</em></li></ul></div>
